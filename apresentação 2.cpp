...
{   
    ...
    int sessoes, qntdPessoas, i, idade, opc, inteira=  0, meia = 0, total = 0, mulher = 0, homem = 0, qh = 0, qm = 0, indiceS; char sexo; // informacoes pessoais
    ...
    scanf("%d", &sessoes);
    for( indiceS = 0 ; indiceS < sessoes ; indiceS++ )
    {
	...
	{	 //caso numero de sessoes for aceito	
